...
<title>Everything delivered in a minutes in all cities clickIt App @yield('title_name') </title>
<meta name='viewport' content='width=device-width, initial-scale=1'>
<!-- main css -->
<link rel='stylesheet' type='text/css' media='screen' href="{{asset('assets/customer/css/style.css')}}">
<!-- icons cdn -->
...
<a href="products.html"><img src="{{ asset('assets/customer/images/banner.webp')}}" class="w-full"></a>    
</section> 
  ...
  <div class="max-w-7xl mx-auto px-4 py-12">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 text-sm text-gray-700">
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="privacy.html" class="hover:text-green-600">Privacy Policy</a></li>
          <li><a href="terms.html" class="hover:text-green-600">Terms & Conditions</a></li>
          <li><a href="404.html" class="hover:text-green-600">Refund Policy</a></li>
          <li><a href="404.html" class="hover:text-green-600">Security</a></li>
        </ul>
      </div>
